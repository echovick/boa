<?php echo get_header()?>
    <main class="sessions">
        ...
        <div class="agendas">
            ...
            ?>
                <div class="accordion title txt-md py-5 txt-green"><span class="badge-date txt-white bg-blue text-center txt-sm"><span class="txt-lg"><?php echo date_format($date,"d")?></span><br><?php echo strtoupper(date_format($date,"M"))?></span>Insta-Live Sessions</div>
                    ...
                    ?>
                        <div class="row w-100 item px-5 py-4 dotted-border-bottom-dark mt-4">
                            <div class="col-md-3 col-lg-3 col-4">
                                <img src="<?php echo $session_image?>" alt="" class="w-100">
                            </div>
                            <div class="col-lg-9 col-md-9 col-8">
                                ...
                                <p class="title txt-md txt-dark"><?php echo $session_title?></p>
